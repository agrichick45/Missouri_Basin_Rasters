...
- Future Land Use compilation (2060) from [Chen et al,. 2020](https://www.nature.com/articles/s41597-020-00669-x) mean model RCP6.0 SSP4 and the [Land Use Harmonization v2](https://luh.umd.edu/index.shtml) RCP6.0 SSP4 (from GCAM) described in [Hurtt et al., 2020](https://gmd.copernicus.org/articles/13/5425/2020/gmd-13-5425-2020-discussion.html) for the pasture and rangeland land use categories. Categories were totaled into the GCAM land use designations and filtered by most prominent. 
